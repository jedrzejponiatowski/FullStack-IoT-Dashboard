...
{
    // printf("BME280 reading\n");
    s32 v_uncomp_pressure_s32;
    s32 v_uncomp_temperature_s32;
    s32 v_uncomp_humidity_s32;

    bme280_readings_t retval;
    ...
    if (com_rslt == SUCCESS)
    {
        ...
        if (com_rslt == SUCCESS)
        {
            retval.temperature_C = bme280_compensate_temperature_double(v_uncomp_temperature_s32);
            retval.pressure_hPa = bme280_compensate_pressure_double(v_uncomp_pressure_s32) / 100;
            retval.humidity = bme280_compensate_humidity_double(v_uncomp_humidity_s32);
            *(bme280_readings_t *)out_buff = retval;
        }
        else
        {
