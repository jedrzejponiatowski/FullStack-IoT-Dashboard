...
const LuminousSensor = ({ sensorConfig, sensorData }) => {
  ...
  const getSensorValues = (sensorParams) => {
    return sensorParams.map((sensorParam) => sensorParam.sensorData);
  };
*/
  ...
  return (
    <div className="sensor-container">
      ...
      <div className="sensor-chart-datachart">
        <DataChart sensorData={sensorParams[0].sensorData} />
      </div>
    </div>
  );
};

export default LuminousSensor;
